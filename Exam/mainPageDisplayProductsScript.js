let whereToPutElements = document.getElementsByClassName("products").item(0);
...
for (let object of productArray) {
    ...
    //productName.innerHTML = "АААAAAAAAAAAA asd asd"; 
    ...
    productPrice.className = "product-price d-flex justify-content-between"; 
